...
function App() {
  ...
  return (
    ...
    <p className="text-lg lg:text-xl mb-8">
      Elevate your music journey with Pulse, a cutting-edge music player designed for music enthusiasts like you. Immerse yourself in a seamless and immersive audio experience, where your favorite tunes come to life,Pulse combines sleek design with powerful features to redefine how you experience music. Discover a vast library of tracks, create personalized playlists, and enjoy crystal-clear sound quality like never before.
    </p>
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap mt-12">
          ...
          <div className="w-1/4 h-1/4 sm:w-1/2 ">
            <img className="w-2/6 h-2/6" src="https://phoenix.anghcdn.co/adminupload/1541509210339.png" alt="" />
          </div>
        </div>
        <div class="flex flex-wrap mt-12">
        <div className="w-1/4 h-1/4 sm:w-1/2 ">
            <img className="w-2/6 h-2/6" src="https://phoenix.anghcdn.co/adminupload/1541509228462.png" alt="" />
          </div>
          <div class="w-1/6 sm:w-1/2 pt-6 pl-6">
            <h3 class="text-3xl text-white text-whitefont-bold leading-none mb-3">
            Exclusive music
            ...
            <p class="text-white mb-8">
            As a Pulse Plus user, you can benefit from listening to your favorite artists’ new songs exclusively on Pulse Plus.
            </p>
          </div>
        </div>
        <div class="flex flex-wrap mt-12">
          ...
          <div className="w-1/4 h-1/4 sm:w-1/2 ">
            <img className="w-2/6 h-2/6" src="https://phoenix.anghcdn.co/adminupload/1541509131284.png" alt="" />
          </div>
        </div>
        <div class="flex flex-wrap mt-12">
        <div className="w-1/4 h-1/4 sm:w-1/2 ">
            <img className="w-2/6 h-2/6" src="https://phoenix.anghcdn.co/adminupload/1541509181704.png" alt="" />
          </div>
          <div class="w-1/6 sm:w-1/2 pt-6 pl-6">
            <h3 class="text-3xl text-white text-whitefont-bold leading-none mb-3">
            ...
            <p class="text-white mb-8">
            Connect phones remotely without bluetooth and control your music.
            </p>
          </div>
        </div>
        <div class="flex flex-wrap mt-12">
          <div class="w-1/6 sm:w-1/2 pt-6 pl-6">
            ...
            <p class="text-white mb-8">
            Upload music you purchase even if they're not on Anghami. Install our desktop app from www.anghami.com & start uploading.
            </p>
          </div>
          <div className="w-1/4 h-1/4 sm:w-1/2 ">
            <img className="w-2/6 h-2/6" src="https://phoenix.anghcdn.co/adminupload/1541509246248.png" alt="" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
          <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-inherit border mt-4">
            <div class="flex-1 bg-inherit border text-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              <ul class="w-full text-center text-sm">
                <li class="border-b py-4"> <span className="mr-2">&#10003;</span> Play millions of songs</li>
                <li class="border-b py-4"> <span className="mr-2">&#10007;</span> Unlimited downloads</li>
                <li class="border-b py-4"> <span className="mr-2">&#10007;</span>  No ads</li>
                <li class="border-b py-4"> <span className="mr-2">&#10007;</span> Lyrics</li>
                <li class="border-b py-4"> <span className="mr-2">&#10007;</span> Scrub, Rewind, Repeat</li>
                <li class="border-b py-4"> <span className="mr-2">&#10007;</span> High audio quality</li>
                <li class="border-b py-4"> <span className="mr-2">&#10007;</span> Apple TV & Sonos</li>
                <li class="border-b py-4"> <span className="mr-2">&#10007;</span> CarPlay & Android Auto</li>
                <li class="border-b py-4"> <span className="mr-2">&#10007;</span>  Playstation</li>
              </ul>
            </div>
          ...
          <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-inherit border mt-4 sm:-mt-6 shadow-lg z-10">
            <div class="flex-1 bg-inherit border rounded-t rounded-b-none overflow-hidden shadow">
              <div class="w-full p-8 text-3xl text-white font-bold text-center">Pulse Plus</div>
          ...
          <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-inherit border mt-4">
            <div class="flex-1 bg-inherit border text-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              <ul class="w-full text-center text-sm">
              <li class="border-b py-4"> <span className="mr-2">&#10003;</span>  6 individual accounts, 1 plan</li>
              <li class="border-b py-4"> <span className="mr-2">&#10003;</span> Play millions of songs</li>
                <li class="border-b py-4"> <span className="mr-2">&#10003;</span> Unlimited downloads</li>
                <li class="border-b py-4"> <span className="mr-2">&#10003;</span>  No ads</li>
                <li class="border-b py-4"> <span className="mr-2">&#10003;</span> Lyrics</li>
                ...
                <li class="border-b py-4"> <span className="mr-2">&#10003;</span> High audio quality</li>
                <li class="border-b py-4"> <span className="mr-2">&#10003;</span> Apple TV & Sonos</li>
                <li class="border-b py-4"> <span className="mr-2">&#10003;</span> CarPlay, Android Auto & Playstation</li>
              </ul>
            </div>
            <div class="flex-none mt-auto bg-inherit border rounded-b rounded-t-none overflow-hidden shadow p-6">
              <div class="w-full pt-6 text-3xl text-white font-bold text-center">
      ...
      Learn More
          ...
          <div className="w-full h-full sm:w-1/2 ">
            <img className="w-4/6-auto h-full-auto" src="https://cdnweb.anghami.com/web/assets/img/landing/card@2x.png" alt="" />
          </div>
        </div>
        </div>
      </section>
      ...
      <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
          ...
          <Link to='/newsLetter'>
          <a class="toggleColour text-pink-500 no-underline hover:no-underline font-bold text-2xl lg:text-4xl flex" href="#">
            <div className='mr-4'>
          
            <img src="https://static.vecteezy.com/system/resources/thumbnails/014/391/878/small/heart-rate-pulse-icon-on-transparent-background-free-png.png" alt="" className='h-10 w-10' />
            </div>
            News Letter
          </a>
          </Link>
